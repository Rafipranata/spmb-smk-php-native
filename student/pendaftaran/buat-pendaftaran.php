      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item active">
              <a href="list-pendaftaran.php" class="menu-link">
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <!-- / Content -->
                                  <?php
// Pastikan id_users integer (penting untuk foreign key)
...
?>
            ...
            <footer class="content-footer footer bg-footer-theme">
              ...
              <!-- <?php
                  ...
                  //     $agama = $_POST['agama'];
                  //     $jurusan_pertama = $_POST['jurusan_pertama'];
                  //     $jurusan_kedua = $_POST['jurusan_kedua'];

                  //     // contoh insert
                  //     mysqli_query($koneksi, "INSERT INTO pendaftaran 
                  //     (nama, nis, nik, email, no_telp, jenis_kelamin, agama, jurusan_pertama, jurusan_kedua)
                  //     VALUES
                  //     ('$nama','$nis','$nik','$email','$no_telp','$jenis_kelamin','$agama','$jurusan_pertama','$jurusan_kedua')");
                  ...
                  // } else {
                  //     echo "Form tidak dikirim lewat tombol Simpan";
                  // }
              ?>   -->
